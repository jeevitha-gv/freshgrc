...
// SELECT CONCAT(UCASE(LEFT(firstname, 1)), LCASE(SUBSTRING(firstname, 2))) as firstname FROM PEOPLE;
 ...
 public function getAllRisksForRiskOwner(){
        $sql = 'SELECT  r.id as riskId,r.subject as subject,r.created_date as date,r.status as status,r.team as team, u.last_name as riskName,
