    ...
    <div class="kt-grid__item kt-grid__item--fluid kt-login__wrapper">
      <div class="kt-login__container">
        <div class="kt-login__logo" >
            <a>
                <img src="./assets/media/company-logos/fixnix.png" style="height: 130px;width: 150px; margin-top: -60px;">      
            </a>
        </div>
            
          <div class="kt-login__head" style="margin-top: -65px;">
            <h3 class="kt-login__title">Sign Up</h3>
            <div class="kt-login__desc">Try FreshGRC free for 15 days</div>
          </div>
          <form class="kt-login__form kt-form" style="margin-top: -10px;">
            <div class="input-group">
              <input style="color: white;" class="form-control" type="text" placeholder="Fullname"  id="name">
            </div>
            <div class="input-group">
              <input style="color: white;" class="form-control" type="text" placeholder="Email"  autocomplete="off" id="email">
            </div>
            <div class="input-group">
...
<!-- 
    ...
    <!-- <div class="footer" style="padding:0%; background-color: #473ea5; ">
      ...
      <div class="col-md-4 col-sm-4" style="color: block; font-size:16px; margin-top: 20px;">
        <ul>
          <li><a href="tel:+1(647)-825-2925"  style="color: white;">+1 925 395 3684</a></li>
          <li><a href="https://www.fixnix.co/" target="_blank" style="color: white;">Our Product Stack</a></li>
        </ul>
      </div>
         <div class="col-md-4" style="color: block; font-size:15px; margin-top: 20px;">
        <ul>
          <span><span style="color: white;">By signing up, you agree to our</span> <a href="https://www.fixnix.co/terms-of-service-fixnix/" target="_blank" style="color: #cddd18;">T & C</a> <span style="color: white;">and</span> <a href="https://www.fixnix.co/privacy-policy-fixnix/" style="color: #cddd18;">privacy policy</a></span><br>
          <a href="http://www.freshgrc.com/" style="color: #cddd18;">FreshGRC.com </a><span style="color: white;"> powered by </span><a href="https://www.fixnix.co/" style="color: #cddd18;"> FixNix</a>
        </ul>
      </div>
         <!--  <div class="col-md-4">
        <ul>
