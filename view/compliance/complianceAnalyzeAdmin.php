                 ...
                 <tbody>
                    <?php foreach ($allData as $data) { ?>
                     ...
                     <tr>
                         ...
                         <td><button class="btn btn-primary"><a href="/freshgrc/view/compliance/checklistAnalyzeAdmin.php?complianceId=<?php echo $data['complianceId'];?>" style="color: white;">Analyze</a></button></td>
                     </tr>
                 <?php } ?>
