...
<?php foreach($allCompliance as $compliance){ ?>
                                    ...
                                    <button class="btn btn-default"  style="text-align:center; height:200px; width:30%; margin-top: 10px; background-color:white ; color:black; font-size: 12px;" type="submit" id="<?php echo $compliance['id'] ?>" onclick="gotoproperpage(this.id);"> 
                 ...
                 <?php echo $compliance['name'];?>
                  ...
                  <?php } ?>
                          ...
                          <?php foreach($allregulatory as $allreg){ ?>
                                    ...
                                    <button class="btn btn-default"  style="text-align:center; height:200px; width:30%; margin-top: 10px; background-color:white ; color:black; font-size: 12px;" type="submit" id="<?php echo $allreg['Comp_Id'] ?>" onclick="gotoproperpage(this.id);"> 
