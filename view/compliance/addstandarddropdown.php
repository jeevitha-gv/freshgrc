...
<div>
  ...
  <button class="btn btn-outline-secondary" onclick="addstand(), location.reloas(true)" title="Add Checklists" style="cursor: pointer;height: 40px; border-radius: 25px; margin-left: 5px;"><span class="la la-plus-circle"></span></button>
