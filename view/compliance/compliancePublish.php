...
require_once __DIR__.'/../../php/compliance/complianceManager.php';
   $manager = new ComplianceManager();
    session_start();
    $allData = $manager->getAllForPublished(0);
?>
  ...
  <tbody>
      <?php foreach ($allData as $data) { ?>
        <tr>
          ...
          <td><span class="kt-badge  kt-badge--success kt-badge--inline kt-badge--pill"><?php echo $data['complStatus']; ?></span></td>
          <td><button class="btn btn-info">Manage Clauses</a></button></td>
