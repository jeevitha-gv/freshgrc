...
<?php foreach ($allData as $data) { ?>
                    <tr>
                    <td style="display: none;"><?php echo $data['complianceId'];?></td>
                    <td><b><?php echo $data['complianceName'];?></b></td>
                    <td><?php echo $data['description'];?></td>
                    <td><?php echo $data['version'];?></td>
                    <td><?php echo $data['company_id'];?></td>
                    <td><?php echo $data['companyName'];?></td>
                    <td style="display: none;"><?php echo $data['complStatus'];?></td>
                    <td><button class="btn btn-primary"><a href="/freshgrc/view/compliance/clauseAdminReview.php?complianceId=<?php echo $data['complianceId']; ?>" style="color: white;">Review</a></button></td>
