...
<?php foreach ($allData as $data) { ?>
                    ...
                    <td><button class="btn btn-success"><a href="/freshgrc/view/compliance/clauseReportAdmin.php?complianceId=<?php echo $data['complianceId']; ?>" style="color: white;">Report</a></button></td>
