...
<thead>
                ...
                <tbody>
                  <tr>
                            ...
                            <td>7</td>  
                             <td>Accept</td>
                            <td><a href="#" class="btn btn-brand btn-danger btn-icon-sm" style="width:100px; height:40% ;  color:#fff; text-align:center;margin: 10px;">
           Review</a></td>
                      </tr>
                  <tr>
                            <td>2</td>
                           ...
                           <td>Mitigated</td>
                            ...
                            <td>7</td>  
                             <td>Research</td>
                           <td><a href="#" class="btn btn-brand btn-danger btn-icon-sm" style="width:100px; height:40% ;  color:#fff; margin: 10px;">
         Review</a></td>   
                      </tr>
