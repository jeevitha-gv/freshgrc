...
require_once __DIR__.'/../../php/risk/riskManager.php';
 $manager = new RiskManager();
    ...
    $allData = $manager->getAllMitigatedRisksForRiskReviewer($userId, $userRole);
...
<?php foreach ($allData as $data) { ?>
                    ...
                    <td><?php echo $data['name'];?></td>
                     <td><button class="btn btn-danger"><a href="/freshgrc/view/risk/riskReview.php?RiskId=<?php echo $data['riskId']; ?>" style="color: white;">Review</a></button></td>
