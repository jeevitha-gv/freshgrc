...
<link href="./assets/vendors/general/@fortawesome/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css" />
  ...
  <link rel="stylesheet" type="text/css" href="assets/DataTables/datatables.min.css" />
   ...
   <link href="./assets/css/demo3/style.bundle.css" rel="stylesheet" type="text/css" />
       ...
       <link rel="shortcut icon" href="http://localhost/freshgrc/assets/images/fixnix-red-logo.png"/>
    </head>
...
<thead>
                ...
                <tbody>
                  <tr>
                            ...
                            <td>Tieba</td>
                            <td>2/12/2018</td>
                            <td>Risk_Mitigator</td>  
                             <td><a href="#" class="btn btn-brand btn-default btn-icon-sm" style="width:114px; height:50% ; background-color: #98FB98; color:#fff; text-align:center;margin: 10px;">
           Low</a></td>
                      </tr>
                  <tr>
                            ...
                            <td>8/6/2017</td>
                            <td>Risk_Mitigator</td>
                           <td><a href="#" class="btn btn-brand btn-default btn-icon-sm" style="width:114px; height:50% ; background-color:red; color:#fff; margin: 10px;">
          Extreme</a></td>   
                      </tr>
                       ...
                       <tr>
                           <td>3</td>
                            ...
                            <td>5/26/2016</td>
                            <td>Risk_Mitigator</td>
                           <td><a href="#" class="btn btn-brand btn-default btn-icon-sm" style="width:114px; height:50% ; background-color: #00FF7F;color:#fff; text-align:center;margin: 10px;">
           Medium</a></td>    
                      </tr>
