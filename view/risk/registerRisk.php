...
<?php foreach ($allData as $data) { ?>
                    ...
                    <td><?php echo $data['riskName'];?></td>
                      ...
                      <td><?php echo $data['calculated_risk_status'];?></td>
                      <td><?php echo $data['status'];?></td>
                     <td><button class="btn btn-success"><a href="/freshgrc/view/risk/mitigateReport.php?riskId=<?php echo $data['riskId']; ?>" style="color: white;">Report</a></button></td>
