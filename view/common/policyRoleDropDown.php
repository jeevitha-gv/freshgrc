...
?>
  ...
  <div class="col-md-4">
    ...
    <div class="input-group select2-bootstrap-prepend">            
      <select  id="policyowner" name="policyOwnerDropDown" class="form-control">
        <option></option>    
  ...
  <div class="col-md-4"> 
    ...
    <div class="input-group select2-bootstrap-prepend">  
      <select  id="policyreviewer" name="policyreviewerDropDown" class="form-control">
        <option></option>    
  ...
  <div class="col-md-4"> 
    ...
    <div class="input-group select2-bootstrap-prepend">          
      <select  id="policyapprover" name="policyapproverDropDown" class="form-control">
        <option></option>    
