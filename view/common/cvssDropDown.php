...
<div class="row">
    <div class="col-md-6">
        ...
        <div class="input-group select2-bootstrap-prepend">
            <select id="attackvector" name="attackvectorDropDown" class="form-control">
                <option></option>
        ...
        <div class="input-group select2-bootstrap-prepend">
            <select id="attackcomplexity" name="attackcomplexityDropDown" class="form-control">
                <option></option>
        ...
        <div class="input-group select2-bootstrap-prepend">
            <select id="authentication" name="authenticationDropDown" class="form-control">
                <option></option>
    ...
    <div class="col-md-6">
        ...
        <div class="input-group select2-bootstrap-prepend">
            <select id="confidentialityimpact" name="confidentialityimpactDropDown" class="form-control">
                <option></option>
        ...
        <label for="integrityimpact">Integrity Impact</label>
            <div class="input-group select2-bootstrap-prepend">
                <select id="integrityimpact" name="integrityimpactDropDown" class="form-control">
                    <option></option>
        ...
        <div class="input-group select2-bootstrap-prepend">
            <select id="availabilityimpact" name="availabilityimpactDropDown" class="form-control">
                <option></option>
    ...
    <div class="col-md-6">
        ...
        <div class="input-group select2-bootstrap-prepend">
            <select id="exploitability" name="exploitabilityDropDown" class="form-control">
                <option></option>
        ...
        <div class="input-group select2-bootstrap-prepend">
            <select id="remediationlevel" name="remediationlevelDropDown" class="form-control">
                <option></option>
        ...
        <div class="input-group select2-bootstrap-prepend">
        <select id="reportconfidence" name="reportconfidenceDropDown" class="form-control">
            <option></option>
    ...
    <div class="col-md-6">
       Impact Subscore Modifiers
        ...
        <div class="input-group select2-bootstrap-prepend">
            <select id="confidentialityrequirement" name="confidentialityrequirementDropDown" class="form-control">
                <option></option>
        ...
        <div class="input-group select2-bootstrap-prepend">
            <select id="integrityrequirement" name="integrityrequirementDropDown" class="form-control">
                <option></option>
        ...
        <div class="input-group select2-bootstrap-prepend">
            <select id="availabilityrequirement" name="availabilityrequirementDropDown" class="form-control">
                <option></option>
...
<div class="row">
    <div class="col-md-6">   
       Environmental Score Metrics
        ...
        <div class="input-group select2-bootstrap-prepend">
            <select id="collateraldamagepotential" name="collateraldamagepotentialDropDown" class="form-control">
                <option></option>
    ...
    <div class="col-md-6">
        <label for="targetdistribution">Target Distribution</label>
         <div class="input-group select2-bootstrap-prepend">
            <select id="targetdistribution" name="targetdistributionDropDown" class="form-control">
                <option></option>
