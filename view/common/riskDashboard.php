...
<div class="row">
<div class="col-md-12">
              <a href="view/common/riskFutureDashboard.php" style="float: right;"><button type="button" class="btn btn-success">Future</button></a>        
      </div>
    </div><br>
                                            ...
                                            <div class="kt-widget17">
                                                ...
                                                <div class="kt-widget17__stats">
                                                    <div class="kt-widget17__items">
                                                        <div class="kt-widget17__item"><a href="view/risk/noofriskdashboard.php">
                                                        ...
                                                        <div class="kt-widget17__item">
                                                          <a href="view/risk/createlist.php">
                                                            <span class="kt-widget17__icon">
                                                    ...
                                                    <div class="kt-widget17__items">
                                                        <div class="kt-widget17__item"><a href="./view/risk/mitigated.php">
                                                            <span class="kt-widget17__icon">
                                                        ...
                                                        <div class="kt-widget17__item"><a href="./view/risk/reviewed.php">
                                                            <span class="kt-widget17__icon">
