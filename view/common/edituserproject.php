                ...
                <div class="kt-grid__item kt-grid__item--fluid kt-wizard-v4__wrapper">
                    ...
                    <form class="kt-form" id="kt_user_add_form">
                        ...
                        <div class="kt-wizard-v4__content" data-ktwizard-type="step-content" data-ktwizard-state="current">
                            <button class="btn btn-danger" style="font-size:20px;float:right;"><a href="view/common/bulkinvite.php"><i class="fa fa-industry" style="color:white;"> BulkInvite</i></a></button>
                            ...
                            <input type="hidden" class="form-control" id="company" value="7">
                                                    ...
                                                    <div class="col-lg-9 col-xl-9">
                                                        <input class="form-control" type="text" id="project_name" value="<?php echo $data['project_name'];?>">
                                                    </div>
                                                </div>
                                                     <?php } ?>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-9 col-xl-9">
                                                        <input class="form-control" type="text" id="project_description" value="<?php echo $data['project_description'];?>">
                                                    </div>
                                                </div>
                                                 <div class="form-group row">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-xl-3 col-lg-3 col-form-label">Created Date</label>
                                                    <div class="col-lg-9 col-xl-9">
                                                        <div class="input-group">
                                ...
                                <div class="kt-wizard-v4__review">
                                    <div class="kt-wizard-v4__review-item">
                                        ...
                                        <div class="kt-wizard-v4__review-content">
                                          <label><b>ProjectName:</b></label><p id="result1"></p>
                                           <label><b>ProjectDescription:</b></label><p id="result2"></p>
                                           <label><b>Team:</b></label><p id="result3"></p>
                                           <label><b>Created Date:</b></label><p id="result4"></p>
...
<script type="text/javascript">
    function showvalue()
    {
        var firstName=document.getElementById('project_name').value;
        document.getElementById('result1').innerHTML=firstName;
        var lastName=document.getElementById('project_description').value;
        document.getElementById('result2').innerHTML=lastName;
           var email=document.getElementById('assigned_to').value;
        document.getElementById('result3').innerHTML=email;
         var phone=document.getElementById('created_date').value;
