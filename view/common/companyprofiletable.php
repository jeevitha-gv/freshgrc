...
$allUsersArray = $manager->companyprofiletable($companyId);
 ?>
<!DOCTYPE html>
...
<div class="kt-header__topbar">
   ...
   <div class="kt-header__topbar-item dropdown kt-header__topbar-item--langs">
           ...
           <span class="kt-header__topbar-icon" title="adduser"><i class="flaticon-graph"></i></span>
           <span class="kt-hidden kt-badge kt-badge--dot kt-badge--notify kt-badge--sm"></span></a>
   
         <a href="view/common/companyprofiletable.php" style="margin-top: 15px;">
...
<?php foreach ($allUsersArray as $data) { ?>
                    ...
                    <td><?php echo $data['department']; ?></td>
                      <td><button class="btn btn-primary"><a href="/freshgrc/view/common/inviteuser.php?auditId=<?php echo $data['id']; ?>" style="color: white;">Edit</a></button></td>
