                    ...
                    <tbody>
                        <?php foreach ($allAudits as $data) { ?>
                            <tr>
                                ...
                                <td><?php echo $data['update_date_update']; ?></td>
                                <td><?php echo $data['review_date']; ?></td>
                                <td><?php echo $data['last_name']; ?></td>
                                <td><?php echo $data['status']; ?></td>
                                <td><button class="btn btn-primary"><a href="/freshgrc/view/bcpm/bcpmPlan.php?id=<?php echo $data['id'];?>" style="color: white;">plan</a></button></td>
                            </tr>
                        <?php } ?>
                    </tbody>
                </table>
...
<?php 
    ...
    <!--begin:: Global Mandatory Vendors -->
    <script src="js/bcpm/bcpmCreateManagement.js"></script>
