                    ...
                    <tbody>
                        <?php foreach ($allAudits as $data) { ?>
                            <tr>
                                ...
                                <td><?php echo $data['assumption']; ?></td>
                                <td><?php echo $data['last_name']; ?></td>
                                <td><?php echo $data['status']; ?></td>

                                <td><button class="btn btn-primary"><a href="/freshgrc/view/bcpm/bcpmmaintenance.php?id=<?php echo $data['id'];?>" style="color: white;">maintain</a></button></td>
...
include '../audit/sidemenu.php';
 ...
 ?>
    ...
    <!--begin:: Global Mandatory Vendors -->
<script src="js/bcpm/bcpmMaintainenceManagement.js"></script>
