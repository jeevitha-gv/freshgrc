                    ...
                    <tr>
                        ...
                        <?php foreach ($allAudits as $data) { ?>
                            <tr>
                                ...
                                <td><?php echo $data['update_office_location']; ?></td>
                                <td><?php echo $data['status']; ?></td>
                                <td><button class="btn btn-primary"><a href="/freshgrc/view/bcpm/bcpmReportAdmin.php?id=<?php echo $data['id'];?>" style="color: white;">Report</a></button></td>
                            </tr>
                        <?php } ?>
                    </tbody>            
                  </table>
