        ...
        <div class="panel-heading text-center" style=" background-color: #5bc0de;     ">My Audits
          ...
          <div class="portlet-body ">
            <?php if($_SESSION['user_role'] == 'incident_manager') {?>
                <div class="clearfix" id="diagnosis">
                    <button class="btn btn-primary" style="margin-left: 20px;" onclick="performIncidentDiagnosis()"><i class="fa fa-user"></i> Diagnosis</button>
                </div>
            <?php }?>
            <?php if($_SESSION['user_role'] == 'incident_resolver') {?>
                <div class="clearfix" id="resolution">
                    <button class="btn btn-primary " style="margin-left: 20px;" onclick="performIncidentResolution()"><i class="fa fa-user"></i>Resolution</button>
                </div>
                <div class="col-xs-2" id="closure" style="margin-left: 150px; margin-top: -30px;">
                    <button class="btn btn-primary"  onclick="performIncidentClosure()" style="margin-left: -3px;"><i class="fa fa-user"></i> Closure</button>
                </div>
            <?php }?>
            <?php if($_SESSION['user_role'] == 'incident_reviewer') {?>
                <div class="col-xs-2" id="review">
                    <button class="btn purple-intense"  onclick="performIncidentReview()"><i class="fa fa-user"></i> Report</button>
                </div>
            <?php }?>      
...
<?php foreach ($allData as $data) { ?>
                    ...
                    <td><?php echo $data['IncidentTitle'];?></td>
                    <td><?php echo $data['IncidentType'];?></td>
                    <td><?php echo $data['IncidentCategory'];?></td>
                    <td><?php echo $data['IncidentStatus'];?></td>
                    <td>incident_analyst</td>
              
                    <td><button class="btn btn-primary"><a href="/newtheme/view/incident/diagnosis1.php" style="color: white;">Diagnosis</a></button></td>
...
<tbody>
                    ...
                    <tr>
                        ...
                        <td></td>
                        <td></td>
                        <td><a href="view/incident/diagnosis1.php"><button class="primary" style="background-color:blue;color:white;">Diagnosis</button></a></td>
