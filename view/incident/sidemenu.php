				...
				<div class="kt-aside  kt-aside--fixed  kt-grid__item kt-grid kt-grid--desktop kt-grid--hor-desktop" id="kt_aside">
					...
					<div class="kt-aside__brand kt-grid__item  " id="kt_aside_brand">
						...
						<?php } ?>
							...
							<?php if($_SESSION['user_role']=='super_admin' ||$_SESSION['user_role']=='incident_analyst') {?>
						...
						<?php } ?>
                       	...
                       	<?php if($_SESSION['user_role']=='incident_analyst' || $_SESSION['user_role']=='incident_resolver' || $_SESSION['user_role']=='incident_reviewer') {?>
					...
					<div class="kt-aside-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_aside_menu_wrapper">
							...
							<ul class="kt-menu__nav ">
								...
								<li class="kt-menu__item " aria-haspopup="true"><a href="view/audit/auditDashboard.php" class="kt-menu__link "><i class="kt-menu__link-icon flaticon2-analytics-2"></i><span class="kt-menu__link-text"> Compliance</span></a></li>
					           	...
					           	<li class="kt-menu__item " aria-haspopup="true"><a href="view/audit/auditDashboard.php" class="kt-menu__link "><i class="kt-menu__link-icon flaticon2-graph"></i><span class="kt-menu__link-text">Policy</span></a></li>
									...
									<li class="kt-menu__item " aria-haspopup="true"><a href="view/incident/plan.php" class="kt-menu__link "><i class="kt-menu__link-icon flaticon2-mail-1"></i><span class="kt-menu__link-text">Incident</span></a>
								</li>
								...
								<li class="kt-menu__item " aria-haspopup="true"><a href="view/audit/auditDashboard.php" class="kt-menu__link "><i class="kt-menu__link-icon eflaticon2-graph"></i><span class="kt-menu__link-text">Bcpm</span></a>
								</li>
						...
						<?php 
							...
							<ul class="kt-menu__nav ">
								...
								<li class="kt-menu__item " aria-haspopup="true"><a href="view/incident/incident_list.php" class="kt-menu__link "><i class="kt-menu__link-icon flaticon2-graph"></i><span class="kt-menu__link-text">Incident List</span></a>
								</li>

								<li class="kt-menu__item " aria-haspopup="true"><a href="view/incident/diagnosis1.php" class="kt-menu__link "><i class="kt-menu__link-icon flaticon2-drop"></i><span class="kt-menu__link-text">Diagnosis</span></a></li>
						...
						<?php 
							...
							<ul class="kt-menu__nav ">
								...
								<li class="kt-menu__item " aria-haspopup="true"><a href="view/incident/incidentList.php" class="kt-menu__link "><i class="kt-menu__link-icon flaticon2-graph"></i><span class="kt-menu__link-text">Resolver</span></a>
								</li>

								<li class="kt-menu__item " aria-haspopup="true"><a href="view/incident/incidentList.php" class="kt-menu__link "><i class="kt-menu__link-icon flaticon2-graph"></i><span class="kt-menu__link-text">Closure</span></a>
								</li>
						...
						<?php if($_SESSION['user_role']=='incident_reviewer') { ?>
							...
							<ul class="kt-menu__nav ">
								...
								<li class="kt-menu__item " aria-haspopup="true"><a href="view/incident/incidentList.php" class="kt-menu__link "><i class="kt-menu__link-icon flaticon2-graph"></i><span class="kt-menu__link-text">Report</span></a>
								</li>
