...
<?php foreach ($allData as $data) { ?>
                    ...
                    <td>
                        <?php if($_SESSION['user_role'] == 'incident_manager') {?>
                            <?php if ($data['IncidentStatus'] == "Recorded") { ?>
                                <button class="btn btn-primary"><a href="/freshgrc/view/incident/diagnosis1.php?IncidentId=<?php echo $data['IncidentId'];?>" style="color: white;"> Diagnosis</a></button>
                        <?php } ?>
                            <?php if($data['IncidentStatus'] == "Closed" || $data['IncidentStatus'] == "Resolved" || $data['IncidentStatus'] == "Assigned") { ?>
                                <button class="btn btn-primary" disabled>Diagnosis</button>
                            <?php } ?>
                    <?php } ?>
