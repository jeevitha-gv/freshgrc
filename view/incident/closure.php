...
<div class="form-group row "> 
   ...
   <div class="col-md-4">            
    ...
    <div class="form-group ">
                        ...
                        <input type="text" id="root_cause" class="form-control">
                        </div>
                    </div>
                            ...
                            <label>Request Type</label>
                               <select id="evaluate" name="assignedtoDropDown" class="form-control">
                                      <option></option>
...
<div class="kt-form__actions">
   ...
   <button class="btn btn-primary" style="float: right;" onclick="closure(<?php echo $IncidentId;?>)"><a href="/freshgrc/view/incident/incidentList.php" style="color: white;">Save</a></button>
