...
require_once __DIR__.'/../../php/incident/incidentManager.php';
    ...
    $allData = $manager->getallIncidentReviewerList();
...
<?php foreach ($allData as $data) { ?>
                    ...
                    <td><button class="btn btn-primary"><a href="/freshgrc/view/incident/closure.php?IncidentId=<?php echo $data['IncidentId'];?>" style="color: white;">Closure</a></button></td>
