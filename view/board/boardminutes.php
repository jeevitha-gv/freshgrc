...
?>
                    ...
                    <?php
$var=$_GET['userid'];
    $sql = "SELECT * from boardagenda WHERE m_no=$var LIMIT 1";
$result = mysqli_query($link, $sql);
...
$m_no = $row['m_no']; 
  ...
  ?>   
                    <div class="col-md-2">
                       <label >Agenda</label>
                      <input type="text" class="form-control" id="agenda" name="agenda" value="<?php echo $row['topic'];?>" style="border: 1px solid #b2abab;"  disabled>
                    </div>
                    <div class="col-md-2">
                       <label >synopsis</label>
                      <input type="text" class="form-control" id="synopsis" name="synopsis" value="<?php echo $row['synopsis'];?>" style="border: 1px solid #b2abab;"  disabled>  
                    </div>
                    <div class="col-md-2">
                       <label >Action Items:</label>
                      <input type="text" class="form-control" id="synopsis" name="action_item" style="border: 1px solid #b2abab;"  required>  
                    </div>
                    <div class="col-md-2" >
                          <div class="form-group" id="user">
                            <div class="form-group" >
        <label for="multi-append" class="control-label" style="font-size: 13px;">Owner</label>
                    ...
                    <div class="col-md-2">
                      ...
                      <input type="Date" class="form-control" id="synopsis" name="deadline" style="border: 1px solid #b2abab;"  required>  
                    </div>
                    </div>
                    </div>
...
?>
                    ...
                    <button type="submit" id="submit" class="btn btn-primary" style="float:right;">Summarize</button>
                  </div>
                </div>
                      </form>
