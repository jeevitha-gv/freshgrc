...
<div class="kt-portlet__body">
              ...
              ?>       
                <form action="" method=POST>
                 <div class="row" style="border: 1px solid #b2abab;">
                             <!-- <div class="col-md-12" > -->
                              <div class="col-md-6" >
                            ...
                            <div class="form-group">
                                <label>Date</label><br>
                                <input type="date" name="date" class="form-control"  id="date" value="<?php echo $_POST['date']; ?>">
                            </div>          
                            </div>  
                             </div><br/><br/>
                ...
                <div class="col-md-6">
                  <label>Purpose</label>
                <textarea type="text" class="form-control" id="purpose" name="purpose"><?php echo $_POST['purpose']; ?></textarea>
              </div>
        
              <div class="col-md-6">
                  <label>Responsibilities</label>
                <textarea type="text" class="form-control" id="responsibities" name="responsibities"><?php echo $_POST['responsibities']; ?></textarea>
              </div>
            </div><br/><br/>
            <div class="row">
              <div class="col-md-12" style="border: 1px solid #b2abab;">
                  <label>Output</label>
                <textarea type="text" class="form-control" id="output" name="output"><?php echo $_POST['output'];?></textarea>
              </div>
            </div><br/><br/>
            <div class="row" style="border: 1px solid #b2abab;">
             <div class="col-md-6">
                          <div class="form-group" id="user">
                            <div class="form-group">
        <label for="multi-append" class="control-label" >Members</label>
...
<div class="kt-form__actions">
                    <button type="submit" id="submit" name="submit" data-dismiss="modal" class="btn btn-primary" style="float: right;">Schedule</button>
                </div>
              </div>
          </form>
        </div>
