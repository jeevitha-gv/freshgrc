...
<tbody>
 <?php
      $sql = "SELECT b.m_no as ID,b.date as date,b.title as Title,b.date as Date,b.frequency as Frequency,b.purpose as Purpose,b.responsibities as Responsibities,b.output as Output FROM boardindex as b,boardagenda as a WHERE b.m_no=a.m_no ORDER BY b.m_no DESC";
  ...
  while($data = mysqli_fetch_array($result))
  {
    ?>
               <tr>
                    ...
                    <td><?php echo $data['Responsibities'];?></td>
                    <td><?php echo $data['Output'];?></td>
                    <td><button class="btn btn-success"><a href="view/board/boardpublish.php?userid=<?php echo $data['ID'];?>" style="color: white;">Publish</a></button></td>
