...
<html>
  ...
  <head lang="en">
    ...
    <script src="../view/.boardmeetingsample.js"></script>
          ...
          <div class="panel panel-primary" style="border-color:#32c5d2;">
            <div class="panel-heading"  style="background-color: #32c5d2;font-size: 18px !important;">TERMS OF REFERENCE</div>
              ...
              <div class="modal-footer" style="border-top: 2px solid #eef1f5;">
                    ...
                    <button type="button" id="manageButton" onclick="saveboard()" data-dismiss="modal" class="btn btn-primary">Schedule</button>
                </div>
          </form>
        </div>
      </div>
