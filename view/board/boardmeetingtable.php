...
<tbody>
 <?php
      $sql = "SELECT * FROM boardindex ORDER BY m_no DESC";
  ...
  while($data = mysqli_fetch_array($result))
  {
    ?>
               <tr>
                    <td style="display: none;"><?php echo $row['m_no'];?></td>
                    ...
                    <td><button class="btn btn-primary"><a href="view/board/boardagenda.php?userid=<?php echo $data['m_no'];?>" style="color: white;">Agenda</a></button></td>
