...
<tbody>
 <?php
      $sql = "SELECT bi.m_no as id,bi.user as Author, bm.action_item as Action_Item,bm.owner as Owner,bm.deadline as Deadline,ba.topic as Agenda,ba.synopsis as Synopsis,bp.summary as Summary FROM boardminutes as bm,boardindex as bi,boardagenda as ba,boardpublish as bp WHERE bm.m_no=ba.m_no AND bi.m_no=bp.m_no AND bm.m_no=bp.m_no AND ba.m_no=bp.m_no ORDER BY bi.m_no DESC";
  ...
  while($data = mysqli_fetch_array($result))
  {
    ?>
               <tr>
                    ...
                    <td><?php echo $data['Action_Item'];?></td>
                    <td><?php echo $data['Owner'];?></td>
                    <td><?php echo $data['Deadline'];?></td>
                    <td><?php echo $data['Agenda'];?></td>
                    <td><?php echo $data['Summary'];?></td>
                    <td><button class="btn btn-warning"><a href="view/board/boardapprove.php?userid=<?php echo $data['id'];?>" style="color: white;">Approved</a></button></td>
