    ...
    <div class="page-content-wrapper" style="margin: 12px;margin-top: -5%;" >
      ...
      <div class="page-content" >
        <div class="panel" style="border: 1px solid #32c5d2;">
          <div class="panel-heading" style="background-color: #32c5d2; color:#fff;font-size: 20px;">Action</div>
        <div class="panel-body">
         <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 text-center">
            <div class="form-group clearfix">
              <div class="col-sm-12">
                <label for="usr" style="font-size: 14px;">Display Name:</label>
                  ...
                  <div class="panel-body">
                    <form name="userForm" id="assetActionForm" >
                       <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                        <div class="form-group clearfix">
                          <div class="col-sm-12">
                            <label for="usr" style="font-size: 14px;">Control for Labelling:</label>
                      ...
                      <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                        <div class="form-group clearfix">
                          <div class="col-sm-12">
                            <label for="usr" style="font-size: 14px;">Control for Disposal:</label>
                              <div class="form-group "  >
                      ...
                      <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                        <div class="form-group clearfix">
                          <div class="col-sm-12">
                            <label for="usr" style="font-size: 14px;">Control for Storage:</label>
                            <div class="form-group "  >
                      ...
                      <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                        <div class="form-group clearfix">
                          <div class="col-sm-12">
                            <label for="usr" style="font-size: 14px;">Control for Transport or Transmission:</label>
                               <div class="form-group "  >
                      ...
                      <!-- </div> -->
                       <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                        <div class="form-group clearfix">
                          <div class="col-sm-12">
                            <label for="usr" style="font-size: 14px;">Control for Addressing:</label>
                              <div class="form-group "  >
                       ...
                       <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                        <div class="form-group clearfix">
                          <div class="col-sm-12">
                            ...
                            <textarea name="description" class="form-control" id="comment"  rows="3"></textarea>
                           </div>
                        </div>
                      </div>
                      <!-- </div> -->
