<?php
 require_once __DIR__.'/../header.php';
  require_once __DIR__.'/../../php/asset/assetManager.php';
    ...
    $allData = $manager->getAllAssetsForReviewer1($userId, $userRole);
?>
<!DOCTYPE html>
...
<link href="./assets/vendors/general/@fortawesome/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css" />
  ...
  <script src="js/asset/assetReviewlistManagement.js"></script>
...
<?php foreach ($allData as $data) { ?>
                    ...
                    <td><button class="btn btn-primary"><a href="/freshgrc/view/asset/assetReview.php?id=<?php echo $data['assetId']; ?>" style="color: white;">Review</a></button></td>
