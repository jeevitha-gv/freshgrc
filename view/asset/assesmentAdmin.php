...
<head lang="en">
    ...
    <script src="js/asset/assesslistManagement.js"></script>
                        ...
                        <div class="col-md-12">
                         <div class="portlet box green">
                                <div class="portlet-title">
                                    <div class="caption">My Audits</div>
          ...
          <div class="portlet-body ">
            <?php if($userRole == 'asset_custodian') {?>
                <div class="col-xs-2" id="kickOffbtn">
                    <button class="btn  btn-block" onclick="performAssetActions()"><i class="fa fa-file"></i>
                    Action</button>
                </div>
