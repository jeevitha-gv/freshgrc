<?php require_once __DIR__.'/../header.php';
  require_once __DIR__.'/../../php/asset/assetManager.php';
    ...
    $allAssets = $manager->getAllAssetsForOwner1($userId, $userRole);
?>
<!DOCTYPE html>
                    ...
                    <tbody>
                        <?php foreach ($allAssets as $data) { ?>
                            <tr>
                                ...
                                <td><button class="btn btn-primary"><a href="/freshgrc/view/asset/assetAssesment.php?id=<?php echo $data['assetId'];?>" style="color: white;">Assessment</a></button></td>
                            </tr>
                        <?php } ?>
                    </tbody>
                </table>
