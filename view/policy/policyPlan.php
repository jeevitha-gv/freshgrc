                      ...
                      <div class="panel-body">               
                        <div class="col-md-4">
                          <div class="form-group">
                            ...
                            <input id="mainheading" type="text" class="form-control mainheading" style="height:55px;">
                          </div>
                        </div>                       
                        <div class="col-md-3"  >
                          <div class="form-group">
                            <label for="auditTitle">Sub Heading</label>
                            <input id="subheading" type="text" class="form-control subheading" style="height:55px;">
                          </div> 
                        </div>                     
                        <div class="col-md-4" >
                          <div class="form-group">
                        ...
                        <div class="form-group" >               
                          <div class="edit-area">                                                  
                            <div class="controls">
                              <button class="btn btn-success add"><i class="fa fa-plus"></i></button> <br><br> <br><br>
                    ...
                    <div class="row">
                      <div class="hidden">                        
                        <div class="example-template">
                         <div style="margin-left: -30px; padding-top: 20px;"><p style="font-weight: bold;">Statement<?php echo $GLOBALS['itemNumber'] ?></p>
                      <div class="panel-body">               
                        <div class="col-md-4">
                          <div class="form-group">
                            <label for="auditTitle">Main Heading</label>
                            <input id="mainheading" type="text" class="form-control mainheading" style="height:55px; width: 102%">
                          </div>
                        </div>                       
                        <div class="col-md-3"  >
                          <div class="form-group" style="margin-left: 8px;">
                            <label for="auditTitle">Sub Heading</label>
                            <input id="subheading" type="text" class="form-control subheading" style="height:55px; width: 105%;">
                          </div> 
                        </div>

                        <div class="col-md-4" >
                          <div class="form-group" style="margin-left: 15px;" >
                            <label for="SecurityRecommendations">Description</label>
                            <textarea id="description1" maxlength="5000" rows="2" class="form-control description" style="width : 106%;" ></textarea>
                          </div>          
                        </div><br>
                        ...
                        <div class="form-group"  >               
                          <div class="edit-area">                                                  
                            <div class="controls">
                        <button class="btn btn-danger rem" style="margin-left: 24px" ><i class="fa fa-minus"></i></button>                          
 ...
 <a href="#" onclick="viewPolicymodelDetails()" data-toggle='modal' data-target='#myModal' class="btn btn-primary">plan</a>
  ...
  <span aria-hidden="true">&times;</span>
        ...
        <div class="modal-body" >
          <table class="table table-striped- table-bordered table-hover  table-checkable" style="width: 670px;height: 520px;">  
