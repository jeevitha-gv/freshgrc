...
<h3 class="kt-portlet__head-title" style="color: white;">Policy Review</h3>
</div>
</div>
                  ...
                  <div class="row">
                    <div class="col-md-4" >
                      <div class="form-group">
                        ...
                        <textarea maxlength="5000" rows="1" class="form-control" id="comment" style="text-transform: capitalize;"></textarea>
                      </div>       
                    </div>
                    <div class="col-md-4" >
                      <div class="form-group">
