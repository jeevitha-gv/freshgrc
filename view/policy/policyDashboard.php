...
$manager=new dashboard();
 ...
 $totalPolicyExpired=$manager->totalPolicyExpired(); 
...
include '../audit/sidemenu.php';
 ...
 ?>
  <script type="text/javascript">
    ...
    $.ajax({
      dataType: "json",
      url: "php/policy/ganttchartpolicy.php",
      data: "",
      success: ganttpolicy
    }); 
    $.ajax({
...
plotOptions: {
 ...
 for(i=0;i<data.length;i++)
     {
    category.push({"label":data[i].startmonth,"start":data[i].created_date,"end":data[i].updated_date});
     } 
 ...
 for(k=0;k<data.length;k++)
     {
    task.push({"start":data[k].created_date,"end":data[k].updated_date});
     } 
...
//       "outlineAlpha": 0.4,
//       "depth3D": 15,
//       "balloonText": "<span style='text-transform:capitalize'>[[title]]</span><br><span style='font-size:14px'><b>[[value]]</b> ([[percents]]%)</span>",
//       "angle": 30,
//       "export": {
//         "enabled": true
//       }
