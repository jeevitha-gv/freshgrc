  ...
  <tbody>
      <?php foreach ($allData as $data) { ?>
        <tr>
          ...
          <td><button class="btn btn-primary"><a href="javascript:;" onclick="show_more_menu();" style="color: white;">Review</a></button>&nbsp;<button class="btn btn-primary" onclick="sendtoreviewer();">Review</button></td>
        <?php }?>
        <?php if($_SESSION['user_role'] == "policy_reviewer") {?>

          <td>
            <?php if($data['status']=="to be reviewed"){?>
