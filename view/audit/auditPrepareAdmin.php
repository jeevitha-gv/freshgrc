...
<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor kt-wrapper" id="kt_wrapper" style="margin-top:-14%;">
...
<?php foreach ($allAudits as $data) { ?>
                    ...
                    <td><button class="btn btn-success"><a href="/freshgrc/view/audit/auditeeDoPage.php?auditId=<?php echo $data['auditId']; ?>" style="color: white;">Respond</a></button></td>
