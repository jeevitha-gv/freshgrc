...
<?php foreach ($allAudits as $data) { ?>
                    ...
                    <td><?php echo $data['audit_freq'];?></td>
                    <td><?php echo $data['status'];?></td>
                    <td><button class="btn btn-primary"><a href="/freshgrc/view/audit/auditDoPage.php?auditId=<?php echo $data['auditId']; ?>" style="color: white;">Kickoff</a></button></td>
