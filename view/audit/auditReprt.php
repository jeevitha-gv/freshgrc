        ...
        <div class="row">
              <div class="col-md-2 col-sm-2" style="margin-top: -5%;" >
                  <div class="dash-notification">
                      <div class="notification-body" style="background-color: #394595;height: 230px;" >
                         <i class="fa fa-tasks" aria-hidden="true" style="color: white;font-size: 20px;"></i>
                          <div class="header-align" style="color: white;font-size: 24px;">
              ...
              <div class="col-md-2 col-sm-2" style="margin-top: -5%;">
                  <div class="dash-notification">
                      <div class="notification-body" style="background-color: #35C142;height: 230px;">
                          <i class="fa fa-balance-scale" aria-hidden="true" style="font-size: 24px;color: white;"></i>
                          <div class="header-align" style="color: white;font-size: 20px;">
              ...
              <div class="col-md-2 col-sm-2"style="margin-top: -5%;">
                  <div class="dash-notification">
                      <div class="notification-body" style="background-color: #2FB5D3;height: 230px;">
                          <i class="fa fa-tasks" aria-hidden="true" style="color: white;font-size: 20px;"></i>
                          <div class="header-align" style="color: white;font-size: 24px;">
              ...
              <div class="col-lg-6 col-xl-6 order-lg-1 order-xl-1"style="margin-top: -5%;" >
...
<div class="kt-portlet kt-portlet--height-fluid">
    <div class="kt-widget14">
        ...
        <div class="kt-widget14__content">  
            <div class="kt-widget14__chart"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div><div class="col-lg-6 col-xl-6 order-lg-1 order-xl-1">
        <!--begin:: Widgets/Profit Share-->
<div class="kt-portlet" style="height: 50px;">
    <div class="kt-widget14">
        <div class="kt-widget14__header">
  
        </div>   
        <div class="kt-widget14__content" style="height: 20px;">  
            <div class="kt-widget14__chart"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
                <div class="kt-widget14__stat"><p><?php echo $GLOBALS['scoreAuditChecklist'] ."/".$GLOBALS['checklistWeight']?></p> <a ui-sref="home.list"><h4 id="delay" style="color: white;"><?php echo $GLOBALS['scoreAuditChecklist'] ."/".$GLOBALS['checklistWeight']?></h4></a></div>
                <canvas id="kt_chart_profit_share" style="height: 140px; width: 140px; display: block;" class="chartjs-render-monitor"></canvas>
            </div>
            <div class="kt-widget14__legends">
              
                <div class="kt-widget14__legend">
                    <span class="kt-widget14__bullet kt-bg-warning"></span>
                    <span class="kt-widget14__stats"><p>Total Checklist Weight:<?php echo $GLOBALS['checklistWeight']?></p>
                    <h4 id="due" style="color:white;"><?php echo $GLOBALS['checklistWeight']?></h4></span>
                </div>
                <div class="kt-widget14__legend">
                    <span class="kt-widget14__bullet kt-bg-brand"></span>
                    <span class="kt-widget14__stats"><p>Audit Overall Score:<?php echo $GLOBALS['scoreAuditChecklist'] ."/".$GLOBALS['checklistWeight']?></p>
                           <h4 id="delay" style="color: white;"><?php echo $GLOBALS['scoreAuditChecklist'] ."/".$GLOBALS['checklistWeight']?></h4></span>
                </div>
            </div>           
...
<div class="kt-portlet__body" style="overflow-x:scroll;font-size:13px; ">
  <table class="table table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
  <thead>
                                        <tr>
                                            <th>Control Set</th>
