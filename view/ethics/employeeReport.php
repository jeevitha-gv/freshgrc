...
$id=$_GET['PolicyId'];
$getdata=$policyManager->getpolicydataToethics($id);

// $GLOBALS['PolicyId'] = $_GET['PolicyId'];

$policyData = $policyManager->getPolicyDetails($id);
$heading=$policyManager->getPolicyheading($id);
...
<div class="form-group row">
    <div class="col-md-6">
      <div class="form-group">
          ...
          <div class="col-lg-9">
       <select id="main_heading" rows="1" class="form-control description">
                                  <?php
                                    for($i=0;$i<count($heading);$i++)
{?>
                                  <option value="<?php echo $heading[$i]['main_heading'];
?>">
                                    <?php

echo $heading[$i]['main_heading'];
?>
                                  </option><?php
                                   }
                                  ?>
    ...
    <div class="col-md-6">
        <div class="form-group">
          ...
          <div class="col-lg-9">
          <select id="subheading" rows="2" class="form-control description">
                                  <?php
                                    for($i=0;$i<count($heading);$i++)
{?>
                                  <option value="<?php echo $heading[$i]['sub_heading'];
?>">
                                    <?php

echo $heading[$i]['sub_heading'];
?>
                                  </option><?php
                                   }
                                  ?>
  ...
  <div class="form-group row">
    <div class="col-md-6">
      <div class="form-group">
          ...
          <div class="col-lg-9">
      <input  type="text" id="name" class="form-control mainheading" required>
        </div>
       </div>
    </div>
    <div class="col-md-6">
        <div class="form-group">
          ...
          <div class="col-lg-9">
        <input  type="text" id="employeeID" class="form-control subheading"  required>
        </div>
       </div>
     </div>
  </div>
    ...
    <div class="col-md-6">
        <div class="form-group">
          ...
          <div class="col-lg-9">
     <input  type="text" id="PolicyId" class="form-control subheading" value="<?php echo $id;?>" disabled>
        </div>
       </div>
     </div>
  </div>
   <div class="form-group row">
    <div class="col-md-6">
      <div class="form-group">
          ...
          <div class="col-lg-9">
            <input  type="date" id="date" class="form-control subheading"  required>
        </div>
       </div>
    </div>
    <div class="col-md-6">
  ...
  <div class="form-group row">
    ...
    <div class="col-md-12">
        <div class="form-group">
          ...
          <div class="col-lg-12">
       <textarea maxlength="5000" id="Reason" rows="1" class="form-control description"></textarea>
        </div>
       </div>
     </div>
  </div>
...
<div class="kt-form__actions">
  <button type="submit" onclick="createEmployee()" data-dismiss="modal" class="btn btn-primary" style="float:right;">Plan</button>
</div>
</div>
            </div>
          </div>
