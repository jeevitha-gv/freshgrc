...
<?php foreach ($allData as $data) { ?>
                    ...
                    <td><?php echo $data['main_heading'];?></td>
                    <td><?php echo $data['policyprocedure'];?></td>
                    <td><button class="btn btn-primary"><a href="/freshgrc/view/ethics/Employeereviewer.php?emplyeeId=<?php echo $data['id']; ?>" style="color: white;">Review</a></button></td>
