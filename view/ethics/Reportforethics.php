      ...
      <div class="kt-portlet">
        ...
        <div class="panel-body">
          <table class="table table-striped list-table table-bordered">
            ...
            <tr>
              <td><label class="col-sm-4">Main Heading:</label>
                <input type="hidden" name="main_heading" id="main_heading" value="<?php echo $alldetails[0]['main_heading'] ;?>">
                <span><?php echo $alldetails[0]['main_heading'] ;?></span>
              </td>
              <td><label  class="col-sm-4">Sub Heading :</label>
                <span><?php echo $alldetails[0]['subheading'] ;?></span>
              </td>
              <td><label  class="col-sm-4">Name:</label>
                <span><?php echo $alldetails[0]['name'] ;?></span>
              </td>
            </tr>
            <tr>                         
              <td><label  class="col-sm-4">Employee Id:</label>
                <span><?php echo $alldetails[0]['employeeID'];?></span>
              </td>
              <td><label  class="col-sm-4">Department:</label>
                <span><?php echo $alldetails[0]['department'];?></span>
              </td>
              <td><label class="col-sm-4">Policy ID:</label>
                <span><?php echo $alldetails[0]['PolicyId'];?></span>
              </td>
            </tr>
            <tr>                          
              <td><label  class="col-sm-4">Location:</label>
                <span><?php echo $alldetails[0]['location'];?></span>
              </td>
               <td><label class="col-sm-4">Date:</label>
                <span><?php echo $alldetails[0]['date'];?></span>
              </td>
              <td><label  class="col-sm-4">Reason:</label>
                <span><?php echo $alldetails[0]['Reason'];?></span>
              </td>                          
            </tr>
          ...
          <table class="table table-striped list-table table-bordered">
            ...
            <tr>
              <td><label class="col-sm-4">Comment:</label>
                <span><?php echo $allcomments[0]['review_comment'];?></span>
              </td>
