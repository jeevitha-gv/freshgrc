...
require_once __DIR__.'/../../php/policy/policyManager.php';
 $manager = new PolicyManager();
    ...
    $allData = $manager->getAllPolicydata($userId, $userRole);
...
<?php foreach ($allData as $data) { ?>
                    <tr>
                    <td style="display: none;"><?php echo $data['PolicyId'];?></td>
                    <td><?php echo $data['start_date'];?></td>
                    <td><?php echo $data['title'];?></td>
                    <td><?php echo $data['policy_type'];?></td>
                    <td><?php echo $data['policyName'];?></td>
                    <td><?php echo $data['status'];?></td>
                    <td><?php echo $data['policyprocedure'];?></td>
                    <td><button class="btn btn-primary"><a href="/freshgrc/view/ethics/employeeReport.php?PolicyId=<?php echo $data['PolicyId']; ?>" style="color: white;">Initiate</a></button></td>
