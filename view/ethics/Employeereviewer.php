...
$allclarifidata=$manager->getAllclarifydata($id);
...
<div class="kt-form__actions">
   <button type="submit" onclick="RejectByReviewer()" data-dismiss="modal" class="btn btn-danger" style="float:right;">Reject</button>
  <button type="submit" onclick="acceptByreviewer()" data-dismiss="modal" class="btn btn-primary" style="float:right;">Accept</button>
</div>
</div>
            </div>
          </div>
