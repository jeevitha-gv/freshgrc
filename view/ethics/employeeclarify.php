...
$alldetfromReview=$manager->getAllreviewdata($id);
$PolicyId=$alldetails[0]['PolicyId'];
$policyManager = new PolicyManager();
$getdata=$policyManager->getpolicydataToethics($PolicyId);

//getting location value
$impload_location=$alldetails[0]['location'];
$explode_location=explode(",",$impload_location);
$location_variable=array();
for($i=0; $i<count($explode_location); $i++)
{
  $loc=$manager->getlocation($explode_location[$i]);
  $location_variable[]=$loc[0]['name'];
}

//getting department value
 $impload_department=$alldetails[0]['department'];
 $explode_department=explode(",",$impload_department);
$department_variable=array();
for($i=0; $i<count($explode_location); $i++)
{
  $dep=$manager->getdepartment($explode_department[$i]);
  $department_variable[]=$dep[0]['name'];
}
...
<div class="form-group row">
    <div class="col-md-6">
      <div class="form-group">
          ...
          <div class="col-lg-9">
      <input typr="text" class="form-control mainheading" value="<?php echo $alldetails[0]['main_heading'] ;?>" readonly>
        </div>
       </div>
    </div>
    <div class="col-md-6">
        <div class="form-group">
          ...
          <div class="col-lg-9">
          <input typr="text" class="form-control mainheading" value="<?php echo $alldetails[0]['subheading'] ;?>" readonly>
        </div>
       </div>
     </div>
  </div>
  ...
  <div class="form-group row">
    <div class="col-md-6">
      <div class="form-group">
          ...
          <div class="col-lg-9">
      <input  type="text" id="name" class="form-control mainheading" value="<?php echo $alldetails[0]['name'] ?>" readonly>
        </div>
       </div>
    </div>
    <div class="col-md-6">
        <div class="form-group">
          ...
          <div class="col-lg-9">
        <input  type="text" id="employeeID" class="form-control subheading" value="<?php echo $alldetails[0]['employeeID'] ?>" readonly>
        </div>
       </div>
     </div>
  </div>
    ...
    <div class="col-md-6">
        <div class="form-group">
          ...
          <div class="col-lg-9">
     <input  type="text" id="PolicyId" class="form-control subheading" value="<?php echo $alldetails[0]['PolicyId'] ?>" readonly>
        </div>
       </div>
     </div>
  </div>
   <div class="form-group row">
    <div class="col-md-6">
      <div class="form-group">
          ...
          <div class="col-lg-9">
            <input  type="date" id="date" value="<?php echo $alldetails[0]['date'] ?>" class="form-control subheading"  readonly>
        </div>
       </div>
    </div>
    <div class="col-md-6">
  ...
  <div class="form-group row">
    ...
    <div class="col-md-12">
        <div class="form-group">
          ...
          <div class="col-lg-12">
        <textarea maxlength="5000"  rows="1" class="form-control description" readonly><?php echo $alldetails[0]['Reason'] ?></textarea>
        </div>
       </div>
     </div>
      <div class="col-md-12">
        <div class="form-group">
          ...
          <div class="col-lg-12">
         <textarea maxlength="5000" id="clarification_reason" rows="1" class="form-control description"></textarea>
        </div>
       </div>
     </div>
  </div>
...
<div class="kt-form__actions">
  <button type="submit" onclick="updateThereviewdata()" data-dismiss="modal" class="btn btn-primary" style="float:right;">Update</button>
</div>
</div>
            </div>
          </div>
