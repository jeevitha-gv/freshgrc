                                  ...
                                  <div class="col-md-4" >
                                    <div class="form-group">
                                      ...
                                      <div class="input-group date">
                                          ...
                                          <input type="text" class="form-control kt_datepicker_2" id="date" name="from" placeholder="Select date"/>
                                      </div>
                                    </div>
                                  </div>
                                  <div class="col-md-4">
                                  ...
                                  <div class="form-group">
                                    <label>Test Date</label>
                                      <div class="input-group input-large date-picker input-daterange" data-date="10/11/2012" data-date-format="yyyy/mm/dd" style="width:100%">
                                        ...
                                        <input type="text" id="test_date" class="form-control kt_datepicker_2" name="from" class="">
                                      </div>
                                    </div>
                                  </div>
                                </div>
