...
<link rel="stylesheet" type="text/css" href="assets/DataTables/datatables.min.css" />
      ...
      <script src="js/disaster/disasterTraining.js"></script>
          ...
          <div class="col-md-12">
           <form id="form1">
            <div class="form-group">
              <input type="" class="form-control" id="loggedInUser" value="<?php echo $_SESSION['user_id'] ?>">
              <input type="" class="form-control" id="disaster_plan_id" value="<?php echo $id?>">
              <input type="" class="form-control" id="action" value="trained">
            </div>
              <div class="row">
                   <div class="col-md-12">
                     <input type="" value="<?php echo $companyId?>" id="company">
                   </div>
               </div>
            <div class="portlet light portlet-fit portlet-datatable bordered">
              <div class="portlet-title">
                <div class="caption">
                  ...
                  <span class="caption-subject font-dark sbold uppercase"> Disaster Plan Details</span>
                </div>
              </div>
                            ...
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                 <div class="input-group-prepend"><span class="input-group-text">@</span></div>
                                  <input type="text" id="internal_email"  class="form-control" value="<?php echo 
                                  $internal_email ?>" readonly> </div>
                            </div>
                          </div>
                          <div class="col-md-4" >
                            <div class="form-group">
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-4" >
                              <div class="form-group">
                                ...
                                <div class="input-group">
                                    <div class="input-group-prepend"><span class="input-group-text">@</span></div>
                                    <input type="text" id="external_email" class="form-control" value="<?php echo $external_email ?>" readonly> </div>
                              </div>
                            </div>
                            <div class="col-md-4" >
                              <div class="form-group">
                          ...
                          <div class="col-md-3">
                            ...
                            <div class="input-group">
                              <div class="input-group-prepend"><span class="input-group-text"><i class="la la-search"></i></span></div>
                                <input type="text" id="system_category" class="form-control " value="<?php echo $system_category ?>" readonly style="text-transform: capitalize;">
                              </div>
                            </div>
                          </div>
                          <div class="col-md-3" >
                          ...
                          <div class="col-md-4" >
                            <div class="form-group" >
                              ...
                              <div class ="col-md-12">
                                <div class="input-group">
                                  <div class="input-group-prepend"><span class="input-group-text"><i class="la la-search"></i></span></div>
                                  <input type="text" id="critical_contract" class="form-control" value="<?php echo $critical_contract ?>"  readonly style="text-transform: capitalize;">
                          ...
                          <div class="col-md-4" >
                            <div class="form-group" >
                              ...
                              <div class ="col-md-12">
                                <div class="input-group">
                                  <div class="input-group-prepend"><span class="input-group-text"><i class="la la-search"></i></span></div>
                                  <input type="text" id="critical_resources" class="form-control" value="<?php echo $critical_resources ?>" readonly style="text-transform: capitalize;">
                                </div>
                              </div>
                            </div>
                          </div> 
                        ...
                        <div class="row">
                          <div class="col-md-3">
                            ...
                            <label >Resource</label>
                              <div class="input-group">
                                <div class="input-group-prepend"><span class="input-group-text"><i class="la la-search"></i></span></div>
                                <input type="text" id="impact_resource" class="form-control" value="<?php echo $impact_resource ?>"  readonly style="text-transform: capitalize;">
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group" >
                            ...
                            <input type="text" class="form-control" style="text-transform: capitalize;" id="summary" required value="<?php echo $summary ?>" readonly>
                        ...
                        <div class="col-md-6">
                          <div class="form-group" >
                            ...
                            <input type="text" style="text-transform: capitalize;" class="form-control"  id="assumption" required value="<?php 
                            echo $assumption ?>" readonly>
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-4" >
                          <div class="form-group " >
                            ...
                            <div class="input-group">
                              <div class="input-group-prepend"><span class="input-group-text"><i class="la la-envelope"></i></span></div>
                          <input type="text" id="covered_system_name" class="form-control" value="<?php echo 
                          $covered_system_name ?>" readonly style="text-transform: capitalize;">
                            </div>
                          </div>          
                        </div>
                      </div>
            ...
            <div class="caption"></i>Training & Approval </div>
            <div class="portlet-body">
              <div class="tabbable-line">
                <ul class="nav nav-tabs nav-tabs-lg">
                  <li class="active">
                    <a href="#Tab_1" data-toggle="tab" aria-expanded="false">Training</a>
                  </li>
                  <li class="">
                    <a href="#Tab_2" data-toggle="tab" aria-expanded="false">Maintanance</a>
                  </li>
                  <li class="">
                    <a href="#Tab_3" data-toggle="tab" aria-expanded="false">Approval</a>
                  </li>
                </ul>
                <div class="tab-content">
                  <div class="tab-pane active" id="Tab_1">
                    <div class="portlet light portlet-fit portlet-datatable bordered">
                      <div class="portlet-title">
                        <div class="caption">
                          <i class="icon-settings font-dark"></i>
                          <span class="caption-subject font-dark sbold uppercase"> Training
                          </span>
                        </div>
                      </div>
                      <div class="portlet-body">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group" >
                                  <div class="input-group">
                                    ...
                                    <div class="input-group input-large date-picker input-daterange" data-date="10/11/2012" data-date-format="yyyy/mm/dd">
                                      ...
                                      <input type="text" id="training_date" class="form-control kt_datepicker_2" >
                                    </div>
                                  </div>
                                </div>
                              </div>
                              <div class="col-md-4" >
                                <div class="form-group">
                                  ...
                                  <div class="input-group">
                                    <div class="input-group-prepend"><span class="input-group-text"><i class="la la-envelope"></i></span></div>
                                    <input type="text" id="training" class="form-control" style="text-transform: capitalize;">
                                  </div>
                                </div>
                              </div>
                            </div>
                      ...
                      <div class="col-md-12">   
                        <div class="portlet light portlet-fit portlet-datatable bordered">
                          <div class="portlet-title">
                            <div class="caption">
                              <i class="icon-settings font-dark"></i>
                                <span class="caption-subject font-dark sbold uppercase">Maintenance
                              </span>
                            </div>       
                          </div>
                          <div class="portlet-body">
                              ...
                              <div class="tab-pane active" id="tab_1">
                                <div class="row">
                                  <div class="col-md-4" >
                                    <div class="form-group">
                                      <div class="input-group">
                                        <label for="exampleInputPassword1">Plan review Date</label>
                                        <div class="input-group input-large date-picker input-daterange" data-date="10/11/2012" data-date-format="yyyy/mm/dd">
                                          <div class="input-group-prepend"><span class="input-group-text"><i class="la la-calendar-check-o"></i></span></div>
                                          <input type="text" id="plan_review_date" class="form-control kt_datepicker_2" >
                                        </div>
                                      </div>
                                    </div>
                                  </div> 
                                  <div class="col-md-4" >
                                    <div class="form-group">
                                      <div class="input-group">
                                        <label for="exampleInputPassword1">Revision Date</label>
                                        <div class="input-group input-large date-picker input-daterange" data-date="10/11/2012" data-date-format="yyyy/mm/dd">
                                          <div class="input-group-prepend"><span class="input-group-text"><i class="la la-calendar-check-o"></i></span></div>
                                          <input type="text" id="revision_date" class="form-control kt_datepicker_2" >
                                        </div>
                                      </div>
                                    </div>
                                  </div> 
                                  <div class="col-md-4">
                                    <div class="form-group">
                                      ...
                                      <div class="input-group">
                                        <div class="input-group-prepend"><span class="input-group-text"><i class="la la-envelope"></i></span></div>
                                        <input type="text" id="summary_of_changes" class="form-control" style="text-transform: capitalize;">
                                      </div>
                                    </div> 
                                  </div>
                                </div>
                      ...
                      <div class="col-md-12">   
                        <div class="portlet light portlet-fit portlet-datatable bordered">
                          <div class="portlet-title">
                            <div class="caption">
                              <i class="icon-settings font-dark"></i>
                              <span class="caption-subject font-dark sbold uppercase">Approval
                              </span>
                            </div>       
                          </div>
                          <div class="portlet-body">
                              ...
                              <div class="tab-pane active" >
                                <div class="row">
                                  <div class="col-md-4" >
                                    <div class="form-group">
                                      <div class="input-group">
                                        ...
                                        <div class="input-group input-large date-picker input-daterange" data-date="10/11/2012" data-date-format="yyyy/mm/dd">
                                          <div class="input-group-prepend"><span class="input-group-text"><i class="la la-calendar-check-o"></i></span></div>
                                          <input type="text" id="approval_revision_date" class="form-control kt_datepicker_2" >
                                        </div>
                                      </div>
                                    </div>
                                  </div>
                                  <div class="col-md-4" >
                                    <div class="form-group">
                                      <div class="input-group">
                                        <label for="exampleInputPassword1">Approval Date</label>
                                          <div class="input-group input-large date-picker input-daterange" data-date="10/11/2012" data-date-format="yyyy/mm/dd">
                                            <div class="input-group-prepend"><span class="input-group-text"><i class="la la-calendar-check-o"></i></span></div>
                                          <input type="text" id="approval_date" class="form-control kt_datepicker_2" >
                                          </div>
                                      </div>
                                    </div>
                                  </div> 
                                  <div class="col-md-4">
                                    <div class="form-group">
                                      <label>Approver Name and Sign</label>
                                      <div class="input-group">
                                        <div class="input-group-prepend"><span class="input-group-text"><i class="la la-envelope"></i></span></div>
                                        <input type="text" id="approver_name_and_sign" class="form-control" style="text-transform: capitalize;">
                                      </div>
                                    </div> 
                                  </div>
                                </div>
            ...
            <div class="kt-portlet__foot">
                <button type="button" class="btn btn-primary" style="float: right;" onclick="manageModal5()">Submit</button>      
              </div>  
            </div>
      </div>
    </div>
