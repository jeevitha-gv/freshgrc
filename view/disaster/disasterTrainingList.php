...
require_once __DIR__.'/../../php/disaster/disasterManager.php';
    ...
    $allData = $manager->getAllDisastersForDisasterTrainer($userId, $userRole);
    ?>
<!DOCTYPE html>
        ...
        <table id="kt_table_1" class="table table-striped- table-bordered table-hover table-checkable">
            <thead>
              <tr> 
                  <th>Id</th>
                  <th>Scope</th>
                  <th>Contracted Name</th>
                  <th>Purpose</th>
                  <th>Company Name</th>
                  <th>Covered_system_name</th>
                  <th>Status</th>
                  <th>Action</th>
              </tr>
            </thead>
            <tbody>
              <?php foreach ($allData as $data) { ?>
                            <tr>
                                ...
                                <td><?php echo $data['contracted_name']; ?></td>
                                <td><?php echo $data['purpose']; ?></td>
                                <td><?php echo $data['company_name']; ?></td>
                                <td><?php echo $data['covered_system_name']; ?></td>
                                <td><?php echo $data['status']; ?></td>
                                <td><button class="btn btn-primary"><a href="/freshgrc/view/disaster/disasterTraining.php?id=<?php echo $data['id']; ?>" style="color: white;">DM Train</a></button></td>
                            </tr>
                        <?php } ?>
            </tbody>
...
<!--begin::Global Theme Bundle(used by all pages) -->
      ...
      <script src="js/disaster/disasterReport.js"></script>
