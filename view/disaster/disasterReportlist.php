                    ...
                    <tbody>
                        <?php foreach ($allData as $data) { ?>
                            <tr>
                                ...
                                <td><button class="btn btn-primary"><a href="/freshgrc/view/disaster/disasterReport.php?id=<?php echo $data['id'];?>" style="color: white;">Report</a></button></td>
                            </tr>
                        <?php } ?>
                    </tbody>
                </table>
