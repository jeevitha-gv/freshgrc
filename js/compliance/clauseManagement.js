...
function manageCheckList() {
    ...
    $.ajax({
        type: "POST",
        url: "/freshgrc/php/compliance/manageChecklist.php",
...
function manageModal() {
    ...
    $.ajax({
        type: "POST",
        url: "/freshgrc/php/compliance/manageClause.php",
        data: modalDetails
    }).done(function (data) {
        location.reload();
    });
...
function saveComplStatus(isDraft){
    ...
    $.ajax({
        ...
        {
        window.location="/freshgrc/view/compliance/complianceReviewAdmin.php";    
        }
        ...
        {
        window.location="/freshgrc/view/compliance/complianceAnalyzeAdmin.php";    
        }
    });
