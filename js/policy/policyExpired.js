...
function showPolicyPlan() {
    window.location = "/newtheme/view/policy/policyPlan.php";
}
function showPolicyReview() {
    var selectedData = table.rows('.selected').data();

    if (selectedData[0][3] == "identified" || selectedData[0][3] == "Returned") {
         window.location = "/newtheme/view/policy/policyPublish.php?PolicyId=" + selectedData[0][0];
    }    
}
function showPolicyApprove() {
    ...
    if (length>0) {
         window.location = "/newtheme/view/policy/policyApprove.php?PolicyId=" + selectedData[0][0];
    }    
}
...
$.ajax({
 ...
 function savePublish(PolicyId){     
    ...
    $.ajax({
        ...
        data: publishDetails        
          ...
          window.location = "/newtheme/view/policy/policyAdmin.php";
    });
 }
 ...
 function saveMailToUsers(){    
   ...
   $.ajax({
        dataType: "json",
        type: "POST",
        url: "/newtheme/php/policy/sendingemail.php",
        data: userCredentials,
 ...
 function getSubPolicy(){
        ...
        $.ajax({
        type: "POST",
        url: "/newtheme/view/policy/policysubpolicy.php",
        data: modalDetails,
        success:function(data){
 ...
 function viewReport() {
    ...
    var length = selectedData.length;
    if (length>0) {
         window.location = "/newtheme/view/policy/policyReport.php?PolicyId=" + selectedData[0][0];
    }    
}
