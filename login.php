...
$num=count($stripval)-1;
  if($stripval[$num]['end_day']!=NULL)
  {
          if(date('Y-m-d')>date('Y-m-d',$stripval[$num]['end_day']))
           {
            header("Location:view/policy/ModuleSelection.php");
           }
         else{
             header($route);
             }
      ...
      {         
        header("Location:view/policy/ModuleSelection.php");      
          ...
          else
           {
             ...
             header("Location:view/policy/ModuleSelection.php?i=1");
           }
    ...
    <div class="kt-grid__item kt-grid__item--fluid kt-login__wrapper">
      <div class="kt-login__container">
        <div class="kt-login__logo">
            <a>
                <img src="./assets/media/company-logos/fixnix.png" style="height: 130px;width: 150px;">      
            </a>
        </div>
        <div class="kt-login__signin">
         ...
         <form class="kt-form" name="login" method="post" name="loginform">
             ...
             <div class="form-group">
                 <input class="form-control form-control-last" style="color: white;" type="password" id="pass" placeholder="Password" name="password">
             </div>
          <!--    <div class="kt-login__extra">
             ...
             <div class="kt-login__actions">
              <button  type="submit" name="login" onclick="lsRememberMe()" class="btn btn-pill kt-login__btn-primary">Sign In</button>
            </div>
             <!-- <div class="kt-login__actions">
        ...
        <div class="kt-login__account">
          ...
          <a href="./signup.php"  class="kt-link kt-link--light kt-login__account-link">Sign Up</a>
        </div>
      </div>  
    </div>
  </div>
